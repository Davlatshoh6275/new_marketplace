...
export default function LogIn() {
  return (
    <div>
      <div className="flex justify-between max-w-[1440px] my-0 mx-auto xl:w-[1200px] h-full items-center xl:pr-[8%] ">
        <div>
          <Image
            src={img}
            alt=""
          ...
          <div className="flex flex-col gap-5 ">
            ...
            <form action="">
              ...
              <div className="flex justify-between gap-3">
                <button
                  type="submit"
                  className="w-1/3 border h-10 rounded-sm bg-[#DB4444] text-white "
                >
                  Log In
                </button>
